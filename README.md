...
- **`mod/`** — **Hitboxes Client**, Fabric-мод для Minecraft 1.16.5+ с
  отладочной панелью (клавиша **Right Shift**) для одиночной игры:
  авто-фарм мобов, визуализация и увеличение хитбоксов мобов, авто-
  поедание золотых/зачарованных яблок, пошаговый авто-строитель ферм.
